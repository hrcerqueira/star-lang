...
val BeautifulIdentifiersMap = List(
  "#" -> "#\uFE0F⃣",
  "\"" -> "\uD83E\uDE87",
  "%" -> "\uD83D\uDD96",
  "<" -> "\uD83D\uDC08",
...
val BeautifulDialect = StarDialect(
  tokenMap = Map(
    "⭐" -> STAR,
    "\uD83C\uDF1F" -> PADDING, // 🌟
    "\uD83D\uDD35" -> DECREMENT, // 🔵
...
private val allDialects = Map(
  "bland" -> BlandDialect,
  "ok" -> OkDialect,
  "beautiful" -> BeautifulDialect,
)
